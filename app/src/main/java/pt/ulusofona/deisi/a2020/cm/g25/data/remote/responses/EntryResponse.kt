package pt.ulusofona.deisi.a2020.cm.g25.data.remote.responses

class EntryResponse(var data: String, var data_dados: String, var confirmados: Int, var confirmados_norte: Int,
