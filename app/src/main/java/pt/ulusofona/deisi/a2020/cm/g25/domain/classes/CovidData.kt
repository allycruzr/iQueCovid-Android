package pt.ulusofona.deisi.a2020.cm.g25.domain.classes

class CovidData(var data: String, var data_dados: String, var confirmados: Int, var confirmados_norte: Int,
